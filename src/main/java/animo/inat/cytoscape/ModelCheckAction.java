...
import animo.inat.cytoscape.modelchecking.PathFormula;
...
public class ModelCheckAction extends InatActionTask
{
    private class RunTask extends AbstractTask
    {
            ...
            EventQueue.invokeLater(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    { //We have a trace to show
                        ...
                        final InatResultPanel resultViewer = new InatResultPanel(model, result.getLevelResult(), scale, Animo.getCytoscapeApp()
        ...
        @Override
        public void run(final TaskMonitor monitor) throws AnalysisException, InatException
        {
            EventQueue.invokeLater(new Runnable()
            {
                @Override
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        System.err.println("Time taken: " + InatActionTask.timeDifferenceFormat(startTime, endTime));
        System.err.flush();
