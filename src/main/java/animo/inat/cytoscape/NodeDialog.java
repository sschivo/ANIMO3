...
public class NodeDialog extends JDialog
{
    ...
    public NodeDialog(final Window owner, final CyNetwork network, final CyNode node)
    {
        ...
        this.add(new LabelledField("Name", nameField), new GridBagConstraints(0, 0, 1, 1, 0.5, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
        ...
        String[] moleculeTypes = new String[] { Model.Properties.TYPE_CYTOKINE, Model.Properties.TYPE_RECEPTOR, Model.Properties.TYPE_KINASE,
        ...
        this.add(new LabelledField("Molecule type", moleculeType), new GridBagConstraints(0, 1, 1, 1, 0.5, 0.0, GridBagConstraints.CENTER,
                GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
        //optionBoxes.add(totalLevelsField);
        //optionBoxes.add(initialLevelField);
        this.add(totalLevelsField, new GridBagConstraints(1, 0, 1, 1, 0.5, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0,
                0));
        this.add(initialLevelField, new GridBagConstraints(1, 1, 1, 1, 0.5, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0,
                0));


        final JRadioButton enabledNode = new JRadioButton("Enabled"), disabledNode = new JRadioButton("Disabled"), plottedNode = new JRadioButton("Plotted"), hiddenNode = new JRadioButton(
                "Hidden");
        ...
        this.add(new LabelledField("Description", descriptionScrollPane), new GridBagConstraints(0, 4, 2, 1, 1.0, 1.0, GridBagConstraints.CENTER,
        ...
        controls.add(new JButton(new AbstractAction("Save")
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                Animo.setRowValue(nodeAttributesRow, Model.Properties.INITIAL_LEVEL, Integer.class, initialConcentration.getValue());
                //nodeAttributesRow.set(Model.Properties.NUMBER_OF_LEVELS, totalLevels.getValue());
                Animo.setRowValue(nodeAttributesRow, Model.Properties.NUMBER_OF_LEVELS, Integer.class, totalLevels.getValue());
                ...
                if (nameField.getText() != null && nameField.getText().length() > 0)
                {
                    ...
                    Animo.setRowValue(nodeAttributesRow, Model.Properties.CANONICAL_NAME, String.class, nameField.getText());

                }
                //nodeAttributesRow.set(Model.Properties.MOLECULE_TYPE, moleculeType.getSelectedItem().toString());
                Animo.setRowValue(nodeAttributesRow, Model.Properties.MOLECULE_TYPE, String.class, moleculeType.getSelectedItem().toString());
