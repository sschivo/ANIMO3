...
public class Model implements Serializable
{
     ...
     */
    private static void checkParameters(Integer nMinutesToSimulate) throws InatException
    {
        ...
        for (CyEdge edge : network.getEdgeList())
        {
            ...
            else
            {
                ...
                //network.getRow(edge).set(Model.Properties.SCENARIO, scenarioIdx);
                Animo.setRowValue(network.getRow(edge), Model.Properties.SCENARIO, Integer.class, scenarioIdx);
                throw new InatException("The reaction " + edgeName + " has an invalid scenario setting (" + scenarioIdx
            ...
            case 1:
                ...
                {
                    throw new InatException("Please check that reactant \"" + source.get(Model.Properties.CANONICAL_NAME, String.class)
                ...
                {
                    throw new InatException("Please check that both reactants \"" + source.get(Model.Properties.CANONICAL_NAME, String.class) + "\" and \""
                            + target.get(Model.Properties.CANONICAL_NAME, String.class) + "\" are enabled, or reaction \"" + edgeName
                            + "\" cannot stay enabled.");
                }
                else if (source.get(Model.Properties.ENABLED, Boolean.class) && !target.get(Model.Properties.ENABLED, Boolean.class))
                {
                    throw new InatException("Please check that reactant \"" + target.get(Model.Properties.CANONICAL_NAME, String.class)
                            + "\" is enabled, or reaction \"" + edgeName + "\" cannot stay enabled.");
                }
                else
                {
            ...
            case 2:
                ...
                {
                    throw new InatException("Please check that reactant \"" + e1.get(Model.Properties.CANONICAL_NAME, String.class)
                            + "\" is enabled, or reaction \"" + edgeName + "\" cannot stay enabled.");
                }
                else if (!e1.get(Model.Properties.ENABLED, Boolean.class) && !e2.get(Model.Properties.ENABLED, Boolean.class)
                        && network.getRow(edge.getTarget()).get(Model.Properties.ENABLED, Boolean.class))
                {
                    throw new InatException("Please check that both reactants \"" + e1.get(Model.Properties.CANONICAL_NAME, String.class) + "\" and \""
                            + e2.get(Model.Properties.CANONICAL_NAME, String.class) + "\" are enabled, or reaction \"" + edgeName + "\" cannot stay enabled.");
                }
                else if (e1.get(Model.Properties.ENABLED, Boolean.class) && !e2.get(Model.Properties.ENABLED, Boolean.class)
                        && network.getRow(edge.getTarget()).get(Model.Properties.ENABLED, Boolean.class))
                {
                    throw new InatException("Please check that reactant \"" + e2.get(Model.Properties.CANONICAL_NAME, String.class)
                            + "\" is enabled, or reaction \"" + edgeName + "\" cannot stay enabled.");
                }
                else if (!e1.get(Model.Properties.ENABLED, Boolean.class) && e2.get(Model.Properties.ENABLED, Boolean.class)
                        && !network.getRow(edge.getTarget()).get(Model.Properties.ENABLED, Boolean.class))
                {
                    throw new InatException("Please check that both reactants \"" + e1.get(Model.Properties.CANONICAL_NAME, String.class) + "\" and \""
                        ...
                        && !network.getRow(edge.getTarget()).get(Model.Properties.ENABLED, Boolean.class))
                {
                    throw new InatException("Please check that reactants \"" + e1.get(Model.Properties.CANONICAL_NAME, String.class) + "\", \""
                        ...
                        && !network.getRow(edge.getTarget()).get(Model.Properties.ENABLED, Boolean.class))
                {
                    throw new InatException("Please check that both reactants \"" + e2.get(Model.Properties.CANONICAL_NAME, String.class) + "\" and \""
                            + network.getRow(edge.getTarget()).get(Model.Properties.CANONICAL_NAME, String.class) + "\" are enabled, or reaction \"" + edgeName
                            + "\" cannot stay enabled.");
                }
                else
