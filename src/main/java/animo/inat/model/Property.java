...
import animo.inat.util.Quadruple;
import animo.inat.util.Table;
import animo.inat.util.Triple;
...
public class Property implements Serializable
{
     ...
     */
    private static final Class<?>[] ACCEPTED_TYPES_ARRAY = { Table.class, String.class, Boolean.class, Integer.class, Float.class };
    ...
    {
        assert this.isA(requested) : "Could not cast property '" + this.name + "' from <" + this.value.getClass().getCanonicalName() + "> to <"
                + requested.getCanonicalName() + ">";
    ...
    {
        assert value == null || isAccepted(value.getClass()) : "Property '" + this.name + "' value type <" + value.getClass().getCanonicalName()
                + "> is not allowed.";
