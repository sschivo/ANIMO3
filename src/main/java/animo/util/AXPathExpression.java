...
/**
 * An augmneted {@link XPathExpression}. This expression provides functionality to evaluate the expression in the context of a given {@link Node} while taking the requested type in
 * consideration.
 * 
 * @author B. Wanders
 */
public class AXPathExpression implements XPathExpression {
	 ...
	 * 
	 * @param root
	 *            the node to be used as context
	 * @return a Node
	 * @throws XPathExpressionException
	 *             if the xpath failed to evaluate
	 */
