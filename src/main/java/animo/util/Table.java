...
/**
 * This class represents a table. This table is indexed in the classical X,Y manner. With X being the first index, and Y being the second index. Column is an alias for X, and Row
 * is an alias for Y.
 * 
...
public class Table implements Iterable<int[]>, Serializable {
	 ...
	 * 
	 * @param row
	 *            the row to retrieve a value from
	 * @param col
