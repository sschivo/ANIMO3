...
/**
 * The button to change the number of real-life seconds represented by a single UPPAAL time unit in the model.
 */
public class ChangeSecondsAction extends AbstractCyAction {

	private static final long serialVersionUID = -9023326560269020342L;

	private static final String SECONDS_PER_POINT = "seconds per point"; // The name of the network property to which the number of real-life seconds per UPPAAL time unit is
																			// associated
	...
	/**
	 * Depending on whether the number of seconds per time unit was already set, we ask a slightly different question to the user. Apart from that, we simply set the property to
