...
public class PathFormula extends JPanel {
	...
	public PathFormula() {
		...
		firstPath.add(first, new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 9));
		firstPath.add(combo1, new GridBagConstraints(1, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 9));
		firstPath.add(state1, new GridBagConstraints(2, 0, 1, 2, 0, 0, GridBagConstraints.PAGE_END,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		firstPath.add(toOccur, new GridBagConstraints(3, 0, GridBagConstraints.REMAINDER, 1, 1, 0,
				GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 9));
		...
		secondPath.add(second, new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 16));
		secondPath.add(ifAState, new GridBagConstraints(1, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 16));
		secondPath.add(state2, new GridBagConstraints(2, 0, 1, 2, 0, 0, GridBagConstraints.PAGE_END,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		secondPath.add(occursThenItIsFollowed, new GridBagConstraints(3, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 16));
		secondPath.add(state3, new GridBagConstraints(4, 0, GridBagConstraints.REMAINDER, 2, 1, 0,
		...
		thirdPath.add(third, new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 9));
		thirdPath.add(aState, new GridBagConstraints(1, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 9));
		thirdPath.add(state4, new GridBagConstraints(2, 0, 1, 2, 0, 0, GridBagConstraints.PAGE_END,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		thirdPath.add(combo2, new GridBagConstraints(3, 0, 1, 1, 0, 0, GridBagConstraints.LINE_START,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 9));
		thirdPath.add(persistIndefinitely, new GridBagConstraints(4, 0, GridBagConstraints.REMAINDER, 1, 1, 0,
				GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 9));
