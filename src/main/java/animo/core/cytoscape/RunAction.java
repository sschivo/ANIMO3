...
import animo.core.network.UPPAALClient;
...
public class RunAction extends AnimoActionTask
{
    private class RunTask extends AbstractTask
    {
            ...
            else
            {
                SwingUtilities.invokeLater(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        final AnimoResultPanel resultViewer = new AnimoResultPanel(model, result, scale, app.getCurrentNetwork());
        ...
        @Override
        public void run(TaskMonitor monitor) throws AnimoException, NumberFormatException, NotBoundException, IOException
        {
            needToStop = false;
