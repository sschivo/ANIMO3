...
public class ColorsLegend extends JPanel
{
    ...
    public void paint(Graphics g1)
    {
        ...
        g.setFont(oldFont);
        g.setPaint(new LinearGradientPaint(rectangle.x + rectangle.width / 2.0f, rectangle.y, rectangle.x + rectangle.width / 2.0f, rectangle.y
                + rectangle.height, fractions, colors));
        g.fill(rectangle);
        g.setPaint(Color.BLACK);
        g.draw(rectangle);

        int[] xT = { (int) (rectangle.x + rectangle.width + 10), (int) (rectangle.x + rectangle.width + 10 + rectangle.width / 2),
