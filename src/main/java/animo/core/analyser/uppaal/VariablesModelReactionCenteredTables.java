...
public class VariablesModelReactionCenteredTables extends VariablesModel {
	...
	protected void appendReactionProcesses(StringBuilder out, Model m, Reaction r, int index) {
		...
		if (r.get(SCENARIO).as(Integer.class) == 0) {
			...
			out.append("_tLower[" + m.getReactant(r2Id).get(NUMBER_OF_LEVELS).as(Integer.class) + "+1]["
		...
		if (r.get(SCENARIO).as(Integer.class) == 0) {
			...
			out.append("_tUpper[" + m.getReactant(r2Id).get(NUMBER_OF_LEVELS).as(Integer.class) + "+1]["
					+ m.getReactant(r1Id).get(NUMBER_OF_LEVELS).as(Integer.class) + "+1] := {");
		}
		out.append(newLine);
		...
		out.append(name + " = Reaction_" + name + "(" + r1Id + ", " + r2Id + ", " + rOutput + ", " + name + "_tLower, "
				+ name + "_tUpper, " + r.get(INCREMENT).as(Integer.class) + ", reacting["
	...
	protected void appendTemplates(StringBuilder out, Model m) {
		try {
			...
			for (Reaction r : m.getReactionCollection()) {
				...
				// document = documentBuilder.parse(new ByteArrayInputStream(("<template><name x=\"5\" y=\"5\">Reaction_" + r.get(CATALYST).as(String.class) + "_" +
				// r.get(REACTANT).as(String.class) + "</name><parameter>int &amp;reactant1, int &amp;reactant2, int &amp;output_reactant, const int timeL[" +
				// m.getReactant(r.get(REACTANT).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) + "+1][" +
				// m.getReactant(r.get(CATALYST).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) + "+1], const int timeU[" +
				// m.getReactant(r.get(REACTANT).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) + "+1][" +
				// m.getReactant(r.get(CATALYST).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) +
				// "+1], const int delta, broadcast chan &amp;r1_reacting, broadcast chan &amp;r2_reacting, broadcast chan &amp;output_reacting</parameter><declaration>// Place local declarations here.\nclock c;\nint r1, r2;</declaration><location id=\"id0\" x=\"-1328\" y=\"-952\"><name x=\"-1338\" y=\"-982\">s2</name></location><location id=\"id1\" x=\"-1064\" y=\"-800\"><name x=\"-1074\" y=\"-830\">s4</name><urgent/></location><location id=\"id2\" x=\"-1328\" y=\"-696\"><name x=\"-1338\" y=\"-726\">s3</name><label kind=\"invariant\" x=\"-1568\" y=\"-720\">timeU[r2][r1] == INFINITE_TIME\n|| c&lt;=timeU[r2][r1]</label></location><location id=\"id3\" x=\"-1328\" y=\"-840\"><name x=\"-1352\" y=\"-864\">s1</name><urgent/></location><init ref=\"id3\"/>"
				// +
				// (!r.get(Model.Properties.R1_IS_DOWNSTREAM).as(Boolean.class)?"<transition><source ref=\"id0\"/><target ref=\"id1\"/><label kind=\"synchronisation\" x=\"-1592\" y=\"-1016\">r1_reacting?</label><label kind=\"assignment\" x=\"-1592\" y=\"-1000\">c:=0</label><nail x=\"-1360\" y=\"-984\"/><nail x=\"-1616\" y=\"-984\"/><nail x=\"-1616\" y=\"-512\"/><nail x=\"-784\" y=\"-512\"/><nail x=\"-784\" y=\"-736\"/></transition>":"")
				// +
				// "<transition><source ref=\"id2\"/><target ref=\"id1\"/><label kind=\"synchronisation\" x=\"-1184\" y=\"-784\">r2_reacting?</label><nail x=\"-1248\" y=\"-768\"/><nail x=\"-1096\" y=\"-768\"/></transition><transition><source ref=\"id2\"/><target ref=\"id1\"/><label kind=\"guard\" x=\"-1096\" y=\"-640\">c&gt;=timeL[r2][r1]\n&amp;&amp; output_reactant+delta&gt;"
				// + m.getReactant(r.get(OUTPUT_REACTANT).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) +
				// "</label><label kind=\"synchronisation\" x=\"-1096\" y=\"-608\">output_reacting!</label><label kind=\"assignment\" x=\"-1096\" y=\"-592\">output_reactant:=" +
				// m.getReactant(r.get(OUTPUT_REACTANT).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) +
				...
				// + m.getReactant(r.get(OUTPUT_REACTANT).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) +
				// "</label><label kind=\"synchronisation\" x=\"-1384\" y=\"-608\">output_reacting!</label><label kind=\"assignment\" x=\"-1384\" y=\"-592\">output_reactant:=output_reactant+delta,\nc:=0</label><nail x=\"-1328\" y=\"-656\"/><nail x=\"-1392\" y=\"-656\"/><nail x=\"-1392\" y=\"-552\"/><nail x=\"-832\" y=\"-552\"/><nail x=\"-832\" y=\"-712\"/></transition>"
				// +
				// (!r.get(Model.Properties.R2_IS_DOWNSTREAM).as(Boolean.class)?"<transition><source ref=\"id0\"/><target ref=\"id1\"/><label kind=\"synchronisation\" x=\"-1592\" y=\"-984\">r2_reacting?</label><label kind=\"assignment\" x=\"-1592\" y=\"-968\">c:=0</label><nail x=\"-1600\" y=\"-952\"/><nail x=\"-1600\" y=\"-528\"/><nail x=\"-800\" y=\"-528\"/><nail x=\"-800\" y=\"-728\"/></transition>":"")
				// +
				...
				// document = documentBuilder.parse(new ByteArrayInputStream(("<template><name x=\"5\" y=\"5\">Reaction_" + r.get(CATALYST).as(String.class) + "_" +
				// r.get(REACTANT).as(String.class) + ((r.get(OUTPUT_REACTANT).as(String.class).equals(r.get(REACTANT).as(String.class))) ? "" : "_" +
				// r.get(OUTPUT_REACTANT).as(String.class)) + "</name><parameter>int &amp;reactant1, int &amp;reactant2, int &amp;output, const int timeL[" +
				// m.getReactant(r.get(REACTANT).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) + "+1][" +
				// m.getReactant(r.get(CATALYST).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) + "+1], const int timeU[" +
				// m.getReactant(r.get(REACTANT).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) + "+1][" +
				// m.getReactant(r.get(CATALYST).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) +
				...
				// + m.getReactant(r.get(OUTPUT_REACTANT).as(String.class)).get(NUMBER_OF_LEVELS).as(Integer.class) +
				// "</label><label kind=\"synchronisation\" x=\"-1096\" y=\"-640\">output_reacting!</label><label kind=\"assignment\" x=\"-1096\" y=\"-624\">output:=output+delta,\nc:=0</label><nail x=\"-1328\" y=\"-696\"/><nail x=\"-1104\" y=\"-696\"/><nail x=\"-1104\" y=\"-592\"/><nail x=\"-928\" y=\"-592\"/><nail x=\"-928\" y=\"-776\"/></transition><transition><source ref=\"id7\"/><target ref=\"id6\"/><label kind=\"guard\" x=\"-1328\" y=\"-992\">timeL[reactant2][reactant1] == INFINITE_TIME</label><nail x=\"-960\" y=\"-976\"/></transition><transition><source ref=\"id9\"/><target ref=\"id6\"/><label kind=\"guard\" x=\"-1536\" y=\"-952\">timeL[reactant2][reactant1] == INFINITE_TIME</label></transition><transition><source ref=\"id7\"/><target ref=\"id8\"/><label kind=\"guard\" x=\"-1320\" y=\"-896\">timeU[reactant2][reactant1] != INFINITE_TIME\n&amp;&amp; c&gt;timeU[reactant2][reactant1]</label><label kind=\"assignment\" x=\"-1320\" y=\"-872\">c:=timeU[reactant2][reactant1],\nr1:=reactant1,r2:=reactant2</label><nail x=\"-1328\" y=\"-856\"/></transition><transition><source ref=\"id7\"/><target ref=\"id8\"/><label kind=\"guard\" x=\"-1320\" y=\"-792\">(timeU[reactant2][reactant1] == INFINITE_TIME\n&amp;&amp; timeL[reactant2][reactant1] != INFINITE_TIME)\n|| (timeU[reactant2][reactant1] != INFINITE_TIME\n&amp;&amp; c&lt;=timeU[reactant2][reactant1])</label><label kind=\"assignment\" x=\"-1320\" y=\"-736\">r1:=reactant1, r2:=reactant2</label><nail x=\"-960\" y=\"-720\"/><nail x=\"-1328\" y=\"-720\"/></transition><transition><source ref=\"id9\"/><target ref=\"id8\"/><label kind=\"guard\" x=\"-1584\" y=\"-880\">timeL[reactant2][reactant1]\n   != INFINITE_TIME</label><label kind=\"assignment\" x=\"-1504\" y=\"-848\">r1 := reactant1,\nr2 := reactant2,\nc := 0</label></transition></template>").getBytes()));
				// Quello qui sotto mette le locazioni start, stubborn e resetting a committed invece che a urgent (a occhio parrebbe servire a renderlo meno non-deterministico, ma
				// forse non tanto..?)
					...
					document = documentBuilder
							.parse(new ByteArrayInputStream(
									("<template><name x=\"5\" y=\"5\">Reaction_"
											...
											+ "</name><parameter>int &amp;reactant1, int &amp;reactant2, int &amp;output, const int timeL["
	...
	protected String getReactionName(Reaction r) {
		/*
		 * String r1Id = r.get(CATALYST).as(String.class); String r2Id = r.get(REACTANT).as(String.class); String rOutput =
		 * r.get(Model.Properties.OUTPUT_REACTANT).as(String.class); return r1Id + "_" + r2Id + ((rOutput.equals(r2Id))? "" : "_" + rOutput);
		 */
