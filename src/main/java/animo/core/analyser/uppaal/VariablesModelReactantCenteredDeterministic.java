...
public class VariablesModelReactantCenteredDeterministic extends VariablesModel {
		...
		protected void appendTemplates(StringBuilder out, Model m) {
			try {
				...
				for (Reactant r : m.getSortedReactantList()) {
					...
					template.append(" <label kind=\"guard\" x=\"-1819\" y=\"-629\">c2 == EPSILON</label>");
					...
					template.append("</transition>");
					template.append("<transition>");
					template.append(" <source ref=\"id2\"/>");
					template.append(" <target ref=\"id7\"/>");
					template.append(" <label kind=\"guard\" x=\"-1419\" y=\"-705\">c2 == EPSILON</label>");
					template.append(" <label kind=\"assignment\" x=\"-1419\" y=\"-688\">update(), ");
					template.append("decide_reset()</label>");
					template.append("</transition>");
					template.append("<transition>");
					...
					template.append(" <label kind=\"guard\" x=\"-1878\" y=\"-697\">c &gt;= tHalf</label>");
