...
public class VariablesModelReactionCentered extends VariablesModel {
	...
	protected void appendModel(StringBuilder out, Model m) {
		...
		out.append(newLine);
		out.append("const double_t INFINITE_TIME_DOUBLE = {-1000, -3}; //INFINITE_TIME translated into double_t");
		out.append(newLine);
		out.append("const double_t timeScale = " + formatDouble(m.getProperties().get(Model.Properties.SECS_POINT_SCALE_FACTOR).as(Double.class)) + "; //The timeScale factor");
		out.append(newLine);
		...
		out.append("const double_t uncertaintyUpper = " + formatDouble(1.0 + unc / 100.0) + ", //uncertainty");
		out.append(newLine);
		out.append("\t\t\t uncertaintyLower = " + formatDouble(1.0 - unc / 100.0) + ";");
		out.append(newLine);
		out.append("");
		out.append(newLine);
		out.append("double_t subtract(double_t a, double_t b) { // a - b");
		out.append(newLine);
		...
		out.append("");
		out.append(newLine);
		out.append("double_t add(double_t a, double_t b) { // a + b");
		out.append(newLine);
		out.append("\tdouble_t r = {-1000,-1000};");
		out.append(newLine);
		out.append("\tif (a.b == 0) {");
		...
		out.append("");
		out.append(newLine);
		out.append("double_t multiply(double_t a, double_t b) { // a * b");
		out.append(newLine);
		...
		out.append("");
		out.append(newLine);
		out.append("double_t inverse(double_t a) { // 1 / a");
		out.append(newLine);
		out.append("\tdouble_t r;");
		out.append(newLine);
		out.append("\tif (a.b == 0) {");
		...
		out.append("");
		out.append(newLine);
		out.append("time_t round(double_t a) { // double --&gt; integer");
		out.append(newLine);
		out.append("\tif (a.e &lt; -3) {");
		out.append(newLine);
		...
		out.append("");
		out.append(newLine);
		out.append("double_t scenario1(double_t k, double_t r1, double_t r1Levels, bool r1Active) {");
		out.append(newLine);
		...
		out.append("");
		out.append(newLine);
		out.append("double_t scenario2_3(double_t k, double_t r2, double_t r2Levels, bool r2Active, double_t r1, double_t r1Levels, bool r1Active) {");
		out.append(newLine);
		...
		out.append("");
		out.append(newLine);
		out.append("double_t int_to_double(int a) { //Used to translate an activity level into double.");
		out.append(newLine);
		out.append("\tdouble_t r;");
		out.append(newLine);
		out.append("\tif (a &lt; 10) {");
