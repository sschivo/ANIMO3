...
public class VariablesModelReactantCenteredMorePreciseNew2 extends VariablesModel {
	...
	protected void appendTemplates(StringBuilder out, Model m) {
		try {
			...
			for (Reactant r : m.getSortedReactantList()) {
				...
				template.append("void decide_react() {\n\tneedToReact = false;\n\tif (rate_significantly_changed(totalRate, compute_rate())) {\n\t\tneedToReact = true;\n\t}\n}\n\n");
				template.append("void react_now() {\n\ttL = 0;\n\ttU = 0;\n\tc = 0;\n}\n\n");
				...
				template.append("<location id=\"id2\" x=\"-1717\" y=\"-629\"><committed/></location>");
				...
				template.append("<transition><source ref=\"id0\"/><target ref=\"id8\"/><label kind=\"guard\" x=\"-1816\" y=\"-598\">c &lt; tHalf</label><label kind=\"assignment\" x=\"-1832\" y=\"-582\">update(), decide_reset()</label><nail x=\"-1848\" y=\"-582\"/><nail x=\"-1464\" y=\"-582\"/></transition>");
				template.append("<transition><source ref=\"id0\"/><target ref=\"id2\"/><label kind=\"guard\" x=\"-1820\" y=\"-646\">c &gt;= tHalf</label><label kind=\"assignment\" x=\"-1832\" y=\"-630\">decide_react()</label><nail x=\"-1840\" y=\"-630\"/></transition>");
				template.append("<transition><source ref=\"id6\"/><target ref=\"id8\"/><label kind=\"assignment\" x=\"-1344\" y=\"-728\">update()</label></transition>");
				template.append("<transition><source ref=\"id2\"/><target ref=\"id8\"/><label kind=\"guard\" x=\"-1606\" y=\"-646\">!needToReact</label><label kind=\"assignment\" x=\"-1606\" y=\"-629\">update()</label><nail x=\"-1470\" y=\"-629\"/></transition>");
				template.append("<transition><source ref=\"id2\"/><target ref=\"id9\"/><label kind=\"guard\" x=\"-1725\" y=\"-688\">needToReact</label><label kind=\"assignment\" x=\"-1725\" y=\"-671\">react_now()</label><nail x=\"-1666\" y=\"-688\"/></transition>");
				int y1 = -904,
					y2 = -888,
					y3 = -848,
					incrY = -40;
