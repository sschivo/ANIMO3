...
public class PropertyBag implements Iterable<Property>, Serializable {
	 ...
	 * @return the property itself, or {@code null} if no such property is available
	 */
	...
	/**
	 * Determines whether a property with the given name is available in this bag.
	 * 
	 * @param name
	 *            the name of the property
	 * @return {@code true} if this property bag contains the requested property, {@code false} otherwise
	 */
	...
	/**
	 * Gets a named property from the bag. If the property did not exist it is created.
	 * 
	 * @param name
	 *            the name of the proeprty to retrieve or create
	 * 
	 ...
	 * 
	 * @param p
	 *            the property who's name should be used
	 */
