...
/**
 * A base entity in the data model. This class exists to provide a base of functionality for all entities stored within an ANIMO data model.
 * 
...
public abstract class Entity implements Serializable {
	 ...
	 * 
	 * @param name
	 *            the name of the proeprty to retrieve
	 * @return the property, or <code>null</code> if the property was not available
	 */
	 ...
	 * @return {@code true} if the property is available, {@code false} otherwise
	 */
